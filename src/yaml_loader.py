...
class YAMLLoader:
    ...
    def load_yaml_file(self, file_path: Union[str, Path]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise YAMLValidationError(f"Invalid YAML format: {e}")
        except Exception as e:
            raise YAMLLoaderError(f"Error reading YAML file: {e}")
    ...
    def find_or_create_model(self, model_name: str, model_type: str = "checkpoint") -> Model:
        ...
        try:
            ...
            raise YAMLLoaderError(f"Database error while handling model '{model_name}': {e}")
    ...
    def create_lora_relationships(
        ...
        try:
            ...
            raise YAMLLoaderError(f"Database error while creating LoRA relationships: {e}")
    ...
    def load_and_insert(self, file_path: Union[str, Path]) -> Run:
        ...
        try:
            ...
            raise YAMLLoaderError(f"Database error during insertion: {e}")
        except Exception as e:
            raise YAMLLoaderError(f"Unexpected error during load_and_insert: {e}")
